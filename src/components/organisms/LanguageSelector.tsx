...
export default function LanguageSelector() {
  ...
  return (
    <div>
      ...
      <div className="fixed inset-x-0 top-8 border-t rounded-t-2xl border-gray-200 text-gray-700 bg-white h-dvh md:sticky md:top-0 md:w-2xs md:border-r md:border-t-0 md:rounded-none overflow-hidden">
